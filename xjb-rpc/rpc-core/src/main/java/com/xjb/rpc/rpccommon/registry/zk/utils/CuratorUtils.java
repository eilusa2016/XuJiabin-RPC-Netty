package com.xjb.rpc.rpccommon.registry.zk.utils;

import com.xjb.rpc.rpccommon.enums.RpcConfigEnum;
import com.xjb.rpc.rpccommon.exception.RpcException;
import com.xjb.rpc.rpccommon.utils.PropertiesFileUtils;
...
public class CuratorUtils {
     ...
     * 创建一个node,和临时的节点不同，persistent类型的不会在断开连接的时候删除
     *
